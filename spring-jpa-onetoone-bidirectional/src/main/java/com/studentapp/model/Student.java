...
public class Student {
	@Id
	@GeneratedValue(generator = "bi_student_gen", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "bi_student_gen", sequenceName = "bi_student_seq", initialValue = 101, allocationSize = 1)
